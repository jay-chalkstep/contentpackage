    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        <div className="p-4 sm:p-6 lg:p-8 max-w-6xl">
          {/* Header */}
          <div className="mb-12">
            <h1 className="text-4xl font-bold text-gray-900 mb-2">Welcome to Aiproval</h1>
            <p className="text-lg text-gray-600">
              Collaborate and validate your designs with your team - all in one simple platform.
            </p>
          </div>
