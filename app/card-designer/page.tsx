  ...
  return (
    <DashboardLayout>
      <div className="max-w-full">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Card Designer</h2>
        <p className="text-gray-600 mb-6">Create custom card mockups with your logos</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
              ...
              {/* Template Selection */}
              <div>
                <label className="text-sm text-gray-600 mb-2 block">Card Template</label>
                <button
              ...
              <div ref={containerRef} className="flex justify-center">
                {selectedTemplate ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-96 text-gray-400">
                    ...
                    <p>Select a card template to begin</p>
                  </div>
                )}
              </div>
            </div>
        ...
        {showTemplateSelector && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg max-w-4xl w-full max-h-[80vh] overflow-hidden">
              <div className="p-6 border-b">
                <h3 className="text-xl font-semibold">Select a Card Template</h3>
              </div>
              <div className="p-6 overflow-y-auto max-h-[60vh]">
